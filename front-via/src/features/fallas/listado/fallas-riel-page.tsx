...
import { FormImportarFallasRiel } from './form-importar-fallas-riel';
...
export function FallasRielPage() {
  const [filtros, setFiltros] =
    useState<FiltrosFallaRiel>(FILTROS_INICIALES);

  const [idAEliminar, setIdAEliminar] =
  ...
  return (
    <>
      <div className="flex flex-col gap-6">
        ...
        {/* ───────────────────────────── */}
        {/* IMPORTAR */}
        {/* FUERA DEL SHEET PRINCIPAL */}
        {/* ───────────────────────────── */}

        {mostrarImportar && (
          <FormImportarFallasRiel
            onClose={() =>
